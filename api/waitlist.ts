          ...
          <html>
            ...
            <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
              ...
              <div style="background: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                <div style="background: linear-gradient(135deg, #667eea15 0%, #764ba215 100%); border-left: 4px solid #667eea; padding: 20px; margin-bottom: 20px; border-radius: 5px;">
                  <h2 style="margin: 0 0 15px 0; color: #667eea; font-size: 18px;">Contact Information</h2>
                  <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                      <td style="padding: 8px 0; color: #666; font-weight: 600; width: 120px;">Name:</td>
                      <td style="padding: 8px 0; color: #333; font-weight: bold;">${fullName}</td>
                    </tr>
                    <tr>
                ...
                <div style="background: #f8f9fa; border-left: 4px solid #764ba2; padding: 20px; border-radius: 5px;">
                  <h2 style="margin: 0 0 15px 0; color: #764ba2; font-size: 18px;">Signup Details</h2>
                  <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                      <td style="padding: 8px 0; color: #666; font-weight: 600; width: 120px;">Source:</td>
                      <td style="padding: 8px 0; color: #333;">
                        <span style="background: #667eea; color: white; padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: 600; text-transform: uppercase;">
                          ${source || 'unknown'}
                        </span>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td style="padding: 8px 0; color: #333; font-weight: 600;">${new Date().toLocaleString('en-US', {
                        weekday: 'long',
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',
                ...
                <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid #e0e0e0; text-align: center;">
                  <p style="margin: 0; color: #666; font-size: 14px;">
                    💡 <strong>Quick Action:</strong> Consider reaching out to welcome them personally!
                  </p>
                </div>
              </div>
              ...
              <div style="text-align: center; padding: 20px; color: #999; font-size: 12px;">
                <p style="margin: 0;">
                  This is an automated notification from MediVault Waitlist System
                </p>
              </div>
            </body>
          </html>
